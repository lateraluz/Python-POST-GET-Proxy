...
# 24-11-2021 Added rangom users-Agents
...
proxy = { "https": "http://192.168.124.110:3128" }
...
def post():
    ...
    largoArray = len(headersUserAgents)
    index = random.sample(range(largoArray),1)[0] 
    
    
    myHeaders = { "Content-Type" : "application/json" ,
                  "User-Agent": headersUserAgents[index]  }
...
def get():
    ...
    #print("GET = "+str(response.text));
    print("GET = "+str(response.status_code));  
    #print( headersUserAgents[index] );
